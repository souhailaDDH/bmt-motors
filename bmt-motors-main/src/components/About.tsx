...
import unnamedPhoto from '../assets/unnamed.jpg'; // ta photo locale
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 text-left">
              ...
              <p className="text-gray-300">
                ...
                Passionné par les motos, je mets cette passion au service de mes clients. 
                Je maîtrise toutes les marques et tous les modèles, des motos classiques aux dernières sportives.
              </p>
              <p className="text-gray-300">
