  ...
  const services = [
    {
      ...
      features: [
        "Diagnostic complet",
        "Réparation / réfection moteur, boîte, coussinets",
        "Remplacement des courroies de distribution",
        "Système de freinage",
        "Changement de pneu",
        "Remplacement des joints spy et entretien de la fourche",
        "Kit chaîne",
        "Entretien du moyeu de roue arrière (monobras)",
        "Révision complète",
        "Jeu aux soupapes",
        "Montage de pièces performance pour la piste",
        "Vidange",
        "Entretien carburateurs avec synchronisation",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Une gamme complète de services pour tous vos besoins moto — du simple entretien à la réparation la plus complexe.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-red-600 to-red-800 rounded-lg p-8 max-w-4xl mx-auto">
              ...
              <p className="text-gray-200 mb-6">
                Contactez-nous pour obtenir plus d'informations sur nos prestations. 
